...
class CarInterface(CarInterfaceBase):
 ...
 #Tune To base Kona EV tune off of.
    ...
    if ret.radarOffCan or ret.mdpsBus == 1 or ret.openpilotLongitudinalControl or ret.sccBus == 1 or Params().get_bool('MadModeEnabled') or Params().get_bool('spasEnabled'):
